...
// ----------------------------------------------------------------
    ...
    case CHC_PROTOCOL::RRU_FW_UPDATE_REQ:
...
bool CHC_PROTOCOL::RRU_FWupdateRP(
    uint8_t dlc,
    uint8_t *payload)
    {
...
unsigned int CHC_PROTOCOL::cal_crc32(const unsigned char *buf, int len, unsigned int init)
{
